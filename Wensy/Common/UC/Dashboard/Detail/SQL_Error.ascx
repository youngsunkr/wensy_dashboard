<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SQL_Error.ascx.cs" Inherits="ServicePoint.Common.UC.Dashboard.Detail.SQL_Error" %>
<div class="col-lg-12">
    <div class="row-fluid">
        <h3 class="text-center">SQL Errorlog</h3>
    </div>
    <div class="row-fluid">
