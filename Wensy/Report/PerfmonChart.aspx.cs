...
{
    public partial class PerfmonChart : Base
    {
        ...
        private List<Lib.chartProperty> SetChartProperty(DataTable dt_rptTable)
        {
            ...
            {
                string strChartNm = "NO_" + dr["Seq"] + "_LINE_CHART";
                cpList.Add(Lib.Flotr2.chartProperty("TimeIn", "PValue", "", strChartNm, "LINE", 0, 0, 130, "true", "true", "false", "true", "true", "false", dr["PObjectName"].ToString(), dr["PCounterName"].ToString(), dr["InstanceName"].ToString()));
            }
        ...
        public string LenSub20(string str)
        {
            if (str.Length > 20)
            {
